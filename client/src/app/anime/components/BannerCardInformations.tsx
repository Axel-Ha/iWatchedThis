...
const BannerCardInformations = ({ anime }: BannerCardInformationsProps) => {
    ...
    return (
        <div className="w-full relative bg-banner bg-cover bg-center">
            <div className="relative z-10 flex flex-row gap-8 max-w-7xl mx-auto py-16  items-center">
                <div className="flex flex-col items-center min-w-[220px]">
                    <img
                        src={coverImage.large}
                        alt={`Cover of ${title.romaji}`}
                        className="object-cover  shadow-lg mt-[-16rem]"
                    />
                ...
                <div className="flex-1 flex flex-col justify-center">
                    ...
                    <nav className="flex flex-row gap-8 mt-2 border-b border-gray-700 pb-2">
