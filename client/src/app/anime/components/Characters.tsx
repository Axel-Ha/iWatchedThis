            ...
            <div className="flex flex-row flex-wrap">
                {characters.map((characterObj, idx) => (
                    <div key={idx} className="flex flex-col mr-5 mb-5 items-center">
                        <img src={characterObj.character.image.medium} alt={characterObj.character.name.full} className="w-[60px] h-[80px] object-cover" />
                        ...
                        <div className="flex flex-row items-center mt-2">
                            {characterObj.voiceActors.map((va, vaIdx) => (
                                <div key={vaIdx} className="flex flex-col items-center mx-1">
                                    <img src={va.image.medium} alt={va.name.full} className="object-cover w-[60px] h-[80px]" />
